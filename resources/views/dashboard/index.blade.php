                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                    <thead>
                        <tr style="background: #f9fafb; border-bottom: 1px solid #e5e7eb;">
                            ...
                            <th style="padding: 10px 20px; text-align: left; font-weight: 600; color: #6b7280;">Last session</th>
                            <th style="padding: 10px 20px; text-align: left; font-weight: 600; color: #6b7280;">Status</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr style="border-bottom: 1px solid #f0f0f0;">
                                <td style="padding: 12px 20px;">
                                    <div style="display: flex; align-items: center; gap: 8px;">
                                        <div style="width: 28px; height: 28px; border-radius: 50%; background: #e0f2fe; color: #0284c7; display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 700; flex-shrink: 0;">
                                ...
                                <td style="padding: 12px 20px; color: #6b7280;">{{ $student->last_session_at?->diffForHumans() ?? 'No sessions' }}</td>
                                <td style="padding: 12px 20px;">
                                    <span style="background: #f0fdf4; color: #16a34a; font-size: 11px; font-weight: 600; padding: 2px 8px; border-radius: 10px; border: 1px solid #bbf7d0;">
                                        Active
                                    </span>
                                </td>
                            </tr>
        ...
        <div style="display: flex; flex-direction: column; gap: 16px;">
            ...
            <div class="card">
                ...
                <div class="card-body" style="display: flex; flex-direction: column; gap: 8px;">
                    <a href="{{ route('admin.students.create') }}" class="btn-sm btn-primary" style="justify-content: center;">
                        <i class="ti ti-user-plus"></i> Add student record
                    </a>
                    <a href="{{ route('feed.create') }}" class="btn-sm" style="justify-content: center;">
                        <i class="ti ti-news"></i> Post to org feed
                    </a>
                    <a href="{{ route('admin.reports.index') }}" class="btn-sm" style="justify-content: center;">
                        <i class="ti ti-chart-bar"></i> Generate report
                    </a>
                </div>
            </div>

            {{-- Common concern trends --}}
            <div class="card">
                <div class="card-header">
                    ...
                    @foreach ($trends ?? [['label' => 'Academic stress', 'pct' => 45], ['label' => 'Family issues', 'pct' => 28], ['label' => 'Mental health', 'pct' => 19], ['label' => 'Other', 'pct' => 8]] as $trend)
                        <div>
                            ...
                            <div style="height: 6px; background: #f0f0f0; border-radius: 4px; overflow: hidden;">
                                <div style="height: 100%; width: {{ $trend['pct'] }}%; background: linear-gradient(90deg, #0f5c42, #1a7a58); border-radius: 4px;"></div>
                            </div>
                        </div>
                    @endforeach
                </div>
...
@elseif (auth()->user()->isStudent())
    ...
    <div class="stat-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-card-value" style="font-size: 16px; padding-top: 4px;">
                {{ $nextAppointment?->scheduled_at->format('M j') ?? 'None' }}
            </div>
            <div class="stat-card-sub">{{ $nextAppointment?->scheduled_at->format('g:i A') ?? 'No upcoming' }}</div>
        </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 16px;">
            ...
            <div class="card" style="border-color: #bbf7d0;">
                <div class="card-body" style="display: flex; gap: 12px; align-items: flex-start;">
                    ...
                    <div>
                        <p style="font-size: 13px; font-weight: 600; color: #111827; margin-bottom: 4px;">Your privacy is protected</p>
